    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""747cdde4-a309-48e5-9360-9e3e2fadae5b"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""52495a9d-358a-42bc-9ae2-bd64f1424282"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""6bd8b599-1b13-474b-a25d-cf11baf42b7f"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""946f1f4e-6060-46e1-940b-839ac3e4d474"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""b78aa4db-9843-47b0-bcdc-c0cba6cf9b17"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""25f71482-29f6-44e9-a824-d47898f0e956"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""9538611a-24bf-4e63-b77c-343a52b2b629"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""Camera"",
            ""id"": ""1eb2a974-54d1-48b3-aed4-dd5faf3ff3d5"",
            ""actions"": [
                {
                    ""name"": ""OverviewLevel"",
                    ""type"": ""Button"",
                    ""id"": ""aff73c5f-7e53-46f5-932e-4a609a957b82"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""329298df-6f51-49c0-a45f-2b79178c1ba9"",
                    ""path"": ""<Keyboard>/c"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";PC"",
                    ""action"": ""OverviewLevel"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
        ...
        {
            ""name"": ""Services"",
            ""id"": ""802b7b84-27ec-4d7c-911a-e44a15fce70a"",
            ""actions"": [
                {
                    ""name"": ""Restart"",
                    ""type"": ""Button"",
                    ""id"": ""02596f22-0588-4fee-8b58-013994827a9e"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""5eaae5d3-9675-499d-8c1e-a134e922a7e1"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";PC"",
    ...
    ""controlSchemes"": [
        {
            ...
            m_Camera_OverviewLevel = m_Camera.FindAction("OverviewLevel", throwIfNotFound: true);
            // Services
        ...
        ~@InputActions()
        {
            ...
            UnityEngine.Debug.Assert(!m_Services.enabled, "This will cause a leak and performance issues, InputActions.Services.Disable() has not been called.");
        }
        ...
        private readonly InputAction m_Camera_OverviewLevel;
        /// <summary>
        ...
        public struct CameraActions
        {
            ...
            /// <summary>
            /// Provides access to the underlying input action "Camera/OverviewLevel".
            /// </summary>
            public InputAction @OverviewLevel => m_Wrapper.m_Camera_OverviewLevel;
            /// <summary>
            /// Provides access to the underlying input action map instance.
            /// </summary>
            ...
            public void AddCallbacks(ICameraActions instance)
            {
                ...
                @OverviewLevel.started += instance.OnOverviewLevel;
                @OverviewLevel.performed += instance.OnOverviewLevel;
                @OverviewLevel.canceled += instance.OnOverviewLevel;
            }
        ...
        public struct ServicesActions
        {
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public ServicesActions(@InputActions wrapper) { m_Wrapper = wrapper; }
            /// <summary>
            ...
            /// Provides access to the underlying input action map instance.
            /// </summary>
            public InputActionMap Get() { return m_Wrapper.m_Services; }
            /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
            public void Enable() { Get().Enable(); }
            /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
            public void Disable() { Get().Disable(); }
            ...
            public bool enabled => Get().enabled;
            /// <summary>
            /// Implicitly converts an <see ref="ServicesActions" /> to an <see ref="InputActionMap" /> instance.
            /// </summary>
            public static implicit operator InputActionMap(ServicesActions set) { return set.Get(); }
            /// <summary>
            /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
            /// </summary>
            /// <param name="instance">Callback instance.</param>
            ...
            /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
            /// </remarks>
            /// <seealso cref="ServicesActions" />
            public void AddCallbacks(IServicesActions instance)
            {
                if (instance == null || m_Wrapper.m_ServicesActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_ServicesActionsCallbackInterfaces.Add(instance);
            ...
            /// </remarks>
            /// <seealso cref="ServicesActions" />
            private void UnregisterCallbacks(IServicesActions instance)
            {
                @Restart.started -= instance.OnRestart;
                @Restart.performed -= instance.OnRestart;
                @Restart.canceled -= instance.OnRestart;
            ...
            /// <summary>
            /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ServicesActions.UnregisterCallbacks(IServicesActions)" />.
            /// </summary>
            /// <seealso cref="ServicesActions.UnregisterCallbacks(IServicesActions)" />
            public void RemoveCallbacks(IServicesActions instance)
            {
                if (m_Wrapper.m_ServicesActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }
            ...
            /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
            /// </remarks>
            /// <seealso cref="ServicesActions.AddCallbacks(IServicesActions)" />
            /// <seealso cref="ServicesActions.RemoveCallbacks(IServicesActions)" />
            /// <seealso cref="ServicesActions.UnregisterCallbacks(IServicesActions)" />
            public void SetCallbacks(IServicesActions instance)
            {
                foreach (var item in m_Wrapper.m_ServicesActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_ServicesActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
        /// <summary>
        /// Provides a new <see cref="ServicesActions" /> instance referencing this action map.
        /// </summary>
        public ServicesActions @Services => new ServicesActions(this);
        ...
        {
            /// <summary>
            /// Method invoked when associated input action "OverviewLevel" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
            /// </summary>
            /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
            /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
            void OnOverviewLevel(InputAction.CallbackContext context);
        }
        /// <summary>
        /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Services" which allows adding and removing callbacks.
        /// </summary>
        /// <seealso cref="ServicesActions.AddCallbacks(IServicesActions)" />
        /// <seealso cref="ServicesActions.RemoveCallbacks(IServicesActions)" />
        public interface IServicesActions
        {
            /// <summary>
